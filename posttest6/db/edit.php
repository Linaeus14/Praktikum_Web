<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM story WHERE file_id = $id");
    ...
    if(isset($_POST["edit"])){
        if (isset($_FILES['fl']['name'])) {
            ...
            $sql2 = "UPDATE story SET judul = '$judul', genre = '$genre', email = '$email', paragraf = '$paragraf' WHERE file_id = $id";
